...
import DiamondNodeComponent from './DiamondNode';
...
const containerWidth = 800; // replace with the actual width of your container
const containerHeight = 600; // replace with the actual height of your container
...
// and equally spaced horizontally within the container
